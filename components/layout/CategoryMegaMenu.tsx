...
function GameIcon({ game, ...props }: { game: string; [key: string]: any }) {
  switch (game) {
    case 'Free Fire':
      return (
        <svg viewBox="0 0 24 24" fill="currentColor" className="text-[#FF5722]" {...props}>
    ...
    case 'Valorant':
      return (
        <svg viewBox="0 0 24 24" fill="currentColor" className="text-[#FA4454]" {...props}>
    ...
    case 'Roblox':
      return (
        <svg viewBox="0 0 24 24" fill="currentColor" className="text-[#ECEFF1]" {...props}>
          <path d="M18.926 23.998 0 18.892 5.075.002 24 5.108ZM15.348 10.09l-5.282-1.453-1.414 5.273 5.282 1.453z" />
        </svg>
      )
    case 'League of Legends':
      return (
        <svg viewBox="0 0 24 24" fill="currentColor" className="text-[#C28F2C]" {...props}>
    ...
    case 'GTA V':
      return (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#2E7D32]" {...props}>
    ...
    case 'CS2':
      return (
        <svg viewBox="0 0 24 24" fill="currentColor" className="text-[#E0A922]" {...props}>
    ...
    case 'Fortnite':
      return (
        <svg viewBox="0 0 24 24" fill="currentColor" className="text-[#00B0FF]" {...props}>
              ...
              {topCategories[0].items?.map(game => (
                <DropdownMenuItem key={game} className="rounded-lg cursor-pointer focus:bg-[var(--gm-paper-3)] p-0">
                  <Link href={`/categoria/jogos/${game.toLowerCase().replace(/ /g, '-')}`} className="flex items-center gap-2.5 text-sm text-[var(--gm-ink-dim)] hover:text-[var(--gm-ink)] py-2 px-3 w-full">
                    <GameIcon game={game} className="h-4.5 w-4.5 shrink-0" />
                    <span>{game}</span>
                  </Link>
                </DropdownMenuItem>
              ))}
